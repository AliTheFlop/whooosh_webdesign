      ...
      <div className="container relative z-10">
        <ScrollAnimation>
          <div className="max-w-3xl mx-auto text-center mb-16">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">Let's Build Something Amazing</h1>
            <p className="text-xl text-muted-foreground">
              Our team of design experts is ready to transform your website into a conversion-focused, ad-ready masterpiece.
            </p>
          </div>
        </ScrollAnimation>
            ...
            <div className="space-y-10">
              <div>
                ...
                <p className="text-muted-foreground mb-8">
                  Whether you need a complete website redesign, ad optimization, or just want to learn more about our services, we're here to help.
                </p>
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">hello@pixelperfect.design</p>
                    </div>
                  </div>
